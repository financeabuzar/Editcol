...
export default function SuccessStories() {
  return (
    <div className="fade-in">
      <section className="max-w-4xl mx-auto px-6 lg:px-10 pt-20 pb-10 text-center">
        ...
        <motion.div
          ...
          <div className="relative">
            ...
            <div className="mt-7 flex flex-wrap gap-3 justify-center">
              <Link to="/ai-match" data-testid="ss-aimatch" className="btn-primary inline-flex items-center gap-2">
                <Sparkles size={16}/> Start a project
              </Link>
              <Link to="/register?role=editor" data-testid="ss-join-editor" className="btn-outline">
                Join as editor
              </Link>
            </div>
          </div>
